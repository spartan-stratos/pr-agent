...
MAX_TOKENS = {
    ...
    **_claude_tokens,
    # Fork-only. ClaudeCliAIHandler shells out to the `claude` CLI, which picks the concrete model
    # itself, so these aliases never pass through _CLAUDE_MODEL_FAMILIES and must be listed by hand.
    'claude_cli/sonnet': 200000,
    'claude_cli/opus': 200000,
    'claude_cli/haiku': 200000,
}
